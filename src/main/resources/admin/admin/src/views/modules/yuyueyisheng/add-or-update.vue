    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="主诉" prop="yuyueyishengContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yuyueyishengContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyueyishengContent" label="主诉" prop="yuyueyishengContent">
                            <span v-html="ruleForm.yuyueyishengContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="时间段" prop="shijidianTypes">
                        <el-select v-model="ruleForm.shijidianTypes" :disabled="ro.shijidianTypes" placeholder="请选择时间段">
                            <el-option
                                v-for="(item,index) in shijidianTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="时间段" prop="shijidianValue">
                        <el-input v-model="ruleForm.shijidianValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huanzheId: false,
                    yishengId: false,
                    yuyueyishengContent: false,
                    yuyueTime: false,
                    shijidianTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    huanzheId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shijidian_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shijidianTypesOptions = data.data.list;
                    }
                });
