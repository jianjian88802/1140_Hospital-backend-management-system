    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="处方内容" prop="zhenduanContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhenduanContent" label="处方内容" prop="zhenduanContent">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chufang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chufangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
